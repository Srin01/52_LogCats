...
class Item(models.Model):
    ...
    category = models.CharField(choices=CATEGORY_CHOICES, default='F',max_length=2)
    label = models.CharField(choices=LABEL_CHOICES,null=True,default='F', max_length=2)
